    ...
    [2682], {
        22682: function(e, t, r) {
            ...
            let s = e => new n("string" == typeof e ? e : e + "", void 0, l),
                c = (e, ...t) => new n(1 === e.length ? e[0] : t.reduce((t, r, i) => t + (e => {
            ...
            y[b] = !0, y.elementProperties = new Map, y.elementStyles = [], y.shadowRootOptions = {
                ...
                ReactiveElement: y
            }), (null !== (ef = m.reactiveElementVersions) && void 0 !== ef ? ef : m.reactiveElementVersions = []).push("1.6.3");
            let x = window,
                $ = x.trustedTypes,
...
\f\r"'\`<>=]|("|')|))|$)`, "g"),
            ...
            let Q = (e, t) => {
                ...
                for (let t = 0; t < r; t++) {
                    let r = e[t],
                        n, s, c = -1,
                        d = 0;
                    for (; d < r.length && (a.lastIndex = d, null !== (s = a.exec(r)));) d = a.lastIndex, a === R ? "!--" === s[1] ? a = L : void 0 !== s[1] ? a = W : void 0 !== s[2] ? (U.test(s[2]) && (o = RegExp("</" + s[2], "g")), a = j) : void 0 !== s[3] && (a = j) : a === j ? ">" === s[0] ? (a = null != o ? o : R, c = -1) : void 0 === s[1] ? c = -2 : (c = a.lastIndex - s[2].length, n = s[1], a = void 0 === s[3] ? j : '"' === s[3] ? N : D) : a === N || a === D ? a = j : a === L || a === W ? a = R : (a = j, o = void 0);
                    let h = a === j && e[t + 1].startsWith("/>") ? " " : "";
                    l += a === R ? r + E : c >= 0 ? (i.push(n), r.slice(0, c) + A + r.slice(c) + _ + h) : r + _ + (-2 === c ? (i.push(void 0), t) : h)
                }
            ...
            class Y {
                constructor({
                    ...
                    let o = 0,
                        ...
                        n = this.parts,
                        [s, c] = Q(e, t);
                    if (this.el = Y.createElement(s, r), F.currentNode = this.el.content, 2 === t) {
            ...
            function G(e, t, r = e, i) {
                ...
                return (null == n ? void 0 : n.constructor) !== s && (null === (l = null == n ? void 0 : n._$AO) || void 0 === l || l.call(n, !1), void 0 === s ? n = void 0 : (n = new s(e))._$AT(e, r, i), void 0 !== i ? (null !== (a = r._$Co) && void 0 !== a ? a : r._$Co = [])[i] = n : r._$Cl = n), void 0 !== n && (t = G(e, n._$AS(e, t.values), n, i)), t
            }
            class X {
                constructor(e, t) {
                ...
                u(e) {
                    ...
                    let {
                        ...
                        parts: i
                    } = this._$AD, o = (null !== (t = null == e ? void 0 : e.creationScope) && void 0 !== t ? t : k).importNode(r, !0);
                    F.currentNode = o;
                    let l = F.nextNode(),
                        a = 0,
                        n = 0,
            ...
            class J {
                ...
                _$AI(e, t = this) {
                    T(e = G(this, e, t)) ? e === V || null == e || "" === e ? (this._$AH !== V && this._$AR(), this._$AH = V) : e !== this._$AH && e !== B && this._(e) : void 0 !== e._$litType$ ? this.g(e) : void 0 !== e.nodeType ? this.$(e) : M(e) ? this.T(e) : this._(e)
                }
                k(e) {
                ...
                _(e) {
                    this._$AH !== V && T(this._$AH) ? this._$AA.nextSibling.data = e : this.$(k.createTextNode(e)), this._$AH = e
                }
                g(e) {
                    var t;
                    let {
                        values: r,
                        _$litType$: i
                    } = e, o = "number" == typeof i ? this._$AC(e) : (void 0 === i.el && (i.el = Y.createElement(K(i.h, i.h[0]), this.options)), i);
            ...
            class ee {
                ...
                _$AI(e, t = this, r, i) {
                    let o = this.strings,
                        l = !1;
                    if (void 0 === o)(l = !T(e = G(this, e, t, 0)) || e !== this._$AH && e !== B) && (this._$AH = e);
                    else {
                        let i, a;
                        let n = e;
                        for (e = o[0], i = 0; i < o.length - 1; i++)(a = G(this, n[r + i], t, i)) === B && (a = this._$AH[i]), l || (l = !T(a) || a !== this._$AH[i]), a === V ? e = V : e !== V && (e += (null != a ? a : "") + o[i + 1]), this._$AH[i] = a
                    }
                    l && !i && this.j(e)
                }
                j(e) {
            ...
            class eo extends ee {
                ...
                _$AI(e, t = this) {
                    var r;
                    if ((e = null !== (r = G(this, e, t, 0)) && void 0 !== r ? r : V) === B) return;
                    let i = this._$AH,
            ...
            null == ea || ea(Y, J), (null !== (eb = x.litHtmlVersions) && void 0 !== eb ? eb : x.litHtmlVersions = []).push("2.8.0");
            let en = (e, t, r) => {
                var i, o;
            ...
            es.finalized = !0, es._$litElement$ = !0, null === (ey = globalThis.litElementHydrateSupport) || void 0 === ey || ey.call(globalThis, {
                LitElement: es
            });
            ...
            var ev, ef, eb, ey, ex, e$, eC = r(90407);
            let eA = {
                    duration: .3,
                    delay: 0,
                    endDelay: 0,
            ...
            let tw = {
                ...
                tf = function(e, t, r = {}) {
                    var i, o, l, a, n;
                    "string" == typeof(i = e) ? o ? (null !== (l = o[i]) && void 0 !== l || (o[i] = document.querySelectorAll(i)), i = o[i]) : i = document.querySelectorAll(i): i instanceof Element && (i = [i]);
                    let s = (e = Array.from(i || [])).length;
                    eG(!!s, "No valid element provided."), eG(!!t, "No keyframes defined.");
                    let c = [];
                    for (let i = 0; i < s; i++) {
                        let o = e[i];
                        for (let e in t) {
                            ...
                            let d = function(e, t, r, i = {}, o) {
                                ...
                                b && tt(e, t);
                                let x = tu(t),
                                    $ = ((l = f.values).has(x) || l.set(x, new eX), l.get(x)),
                                    C = e4.get(x);
                                return ek($.animation, !(eR(p) && $.generator) && !1 !== i.record), () => {
                                    let l = () => {
                                            var t, r;
                                            return null !== (r = null !== (t = tw.get(e, x)) && void 0 !== t ? t : null == C ? void 0 : C.initialValue) && void 0 !== r ? r : 0
                                        },
                                        f = function(e, t) {
                                    ...
                                    if (to(x) && (tc.cssRegisterProperty() ? function(e) {
                                            if (!tl.has(e)) {
                                                tl.add(e);
                                                try {
                                                    let {
                                        ...
                                        }(x) : y = !1), b && !tc.linearEasing() && (eV(p) || eW(p) && p.some(eV)) && (y = !1), y) {
                                        C && (f = f.map(e => eL(e) ? C.toDefaultUnit(e) : e)), 1 === f.length && (!tc.partialKeyframes() || s) && f.unshift(l());
                                        let t = {
                                            delay: e_.ms(d),
                                            duration: e_.ms(c),
                                            endDelay: e_.ms(h),
                                        ...
                                        let t = f[f.length - 1];
                                        tw.set(e, x, C && eL(t) ? C.toDefaultUnit(t) : t)
                                    }
                                    return s && n(e, t, f, {
                                        duration: c,
                                        delay: d,
            ...
            let tR = class extends es {
                ...
                render() {
                    let e = {
                        ...
                        t = "inverse";
                    return "ghost" === this.variant && (t = "secondary"), "outline" === this.variant && (t = "accent"), H `<button class="${eg(e)}" ?disabled="${this.disabled}" @click="${this.onClick}">${this.iconLeft}<wcm-text variant="small-regular" color="${t}"><slot></slot></wcm-text>${this.iconRight}</button>`
                }
            };
            tR.styles = [tI.globalCss, tT], tS([ep({
                type: Boolean
            })], tR.prototype, "disabled", 2), tS([ep()], tR.prototype, "iconLeft", 2), tS([ep()], tR.prototype, "iconRight", 2), tS([ep()], tR.prototype, "onClick", 2), tS([ep()], tR.prototype, "variant", 2), tR = tS([ed("wcm-button")], tR);
            ...
            let tN = class extends es {
                ...
                render() {
                    ...
                    return H `<button ?disabled="${this.disabled}" class="${eg(e)}"><slot></slot></button>`
                }
            };
            tN.styles = [tI.globalCss, tL], tD([ep({
                type: Boolean
            })], tN.prototype, "disabled", 2), tD([ep()], tN.prototype, "variant", 2), tN = tD([ed("wcm-button-big")], tN);
            ...
            var t3 = Object.defineProperty,
                ...
                t7 = (e, t, r, i) => {
                    for (var o, l = i > 1 ? void 0 : i ? t4(t, r) : t, a = e.length - 1; a >= 0; a--)(o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
            ...
            let t6 = class extends es {
                ...
                render() {
                    ...
                    return H `<header class="${eg(e)}">${t?this.backBtnTemplate():null} ${r} ${this.onAction?this.actionBtnTemplate():null}</header>`
                }
            };
            t6.styles = [tI.globalCss, t5], t7([ep()], t6.prototype, "title", 2), t7([ep()], t6.prototype, "onAction", 2), t7([ep()], t6.prototype, "actionIcon", 2), t7([ep({
                type: Boolean
            })], t6.prototype, "border", 2), t6 = t7([ed("wcm-modal-header")], t6);
            let t8 = {
            ...
            ri.styles = [tI.globalCss, t9], rr([eu()], ri.prototype, "view", 2), rr([eu()], ri.prototype, "prevView", 2), ri = rr([ed("wcm-modal-router")], ri);
            ...
            let rs = class extends es {
                ...
                render() {
                    ...
                    return this.open ? H `<div class="${eg({"wcm-success":"success"===t,"wcm-error":"error"===t})}">${"success"===t?tB.CHECKMARK_ICON:null} ${"error"===t?tB.CROSS_ICON:null}<wcm-text variant="small-regular">${e}</wcm-text></div>` : null
                }
            };
            ...
            rs.styles = [tI.globalCss, ro], rn([eu()], rs.prototype, "open", 2), rs = rn([ed("wcm-modal-toast")], rs);
            let rd = {
                    generate(e, t, r) {
                        let i = "#141414",
                            o = [],
                        ...
                        n.forEach(({
                            ...
                            for (let e = 0; e < n.length; e += 1) {
                                let t = a * (7 - 2 * e);
                                o.push(Z `<rect fill="${e%2==0?i:"#ffffff"}" height="${t}" rx="${.45*t}" ry="${.45*t}" width="${t}" x="${r+a*e}" y="${s+a*e}">`)
                            }
                        });
                        ...
                        return h.forEach(([e, t]) => {
                            ...
                            t.forEach(t => {
                                o.push(Z `<circle cx="${e}" cy="${t}" fill="${i}" r="${a/2.5}">`)
                            })
                            ...
                            t.forEach(([t, r]) => {
                                o.push(Z `<line x1="${e}" x2="${e}" y1="${t}" y2="${r}" stroke="${i}" stroke-width="${a/1.25}" stroke-linecap="round">`)
                            })
                        }), o
                    }
                },
            ...
            let rw = class extends es {
                ...
                svgTemplate() {
                    ...
                    return Z `<svg height="${e}" width="${e}">${rd.generate(this.uri,e,e/4)}</svg>`
                }
                render() {
                    let e = {
                        "wcm-dark": "dark" === eC.ThemeCtrl.state.themeMode
                    };
                    return H `<div style="${`width: ${this.size}px`}" class="${eg(e)}">${this.walletId||this.imageUrl?H`<wcm-wallet-image walletId="${ty(this.walletId)}" imageId="${ty(this.imageId)}" imageUrl="${ty(this.imageUrl)}"></wcm-wallet-image>`:tB.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`
                }
            };
            rw.styles = [tI.globalCss, rh], ru([ep()], rw.prototype, "uri", 2), ru([ep({
                type: Number
            })], rw.prototype, "size", 2), ru([ep()], rw.prototype, "imageId", 2), ru([ep()], rw.prototype, "walletId", 2), ru([ep()], rw.prototype, "imageUrl", 2), rw = ru([ed("wcm-qrcode")], rw);
            ...
            ry.styles = [tI.globalCss, rg], rb([ep()], ry.prototype, "onChange", 2), ry = rb([ed("wcm-search-input")], ry);
            ...
            rI.styles = [tI.globalCss, r_], rk([ep()], rI.prototype, "variant", 2), rk([ep()], rI.prototype, "color", 2), rI = rk([ed("wcm-text")], rI);
            ...
            let rR = class extends es {
                ...
                render() {
                    var e;
                    return H `<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${ty(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${null!=(e=this.label)?e:t8.getWalletName(this.name,!0)}</wcm-text>${this.sublabelTemplate()}</div></button>`
                }
            };
            rR.styles = [tI.globalCss, rT], rS([ep()], rR.prototype, "onClick", 2), rS([ep()], rR.prototype, "name", 2), rS([ep()], rR.prototype, "walletId", 2), rS([ep()], rR.prototype, "label", 2), rS([ep()], rR.prototype, "imageId", 2), rS([ep({
                type: Boolean
            })], rR.prototype, "installed", 2), rS([ep({
                type: Boolean
            })], rR.prototype, "recent", 2), rR = rS([ed("wcm-wallet-button")], rR);
            ...
            let rN = class extends es {
                ...
                render() {
                    ...
                    return H `${t.length?H`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>`:tB.WALLET_PLACEHOLDER}`
                }
            };
            rN.styles = [tI.globalCss, rL], rD([ep()], rN.prototype, "walletId", 2), rD([ep()], rN.prototype, "imageId", 2), rD([ep()], rN.prototype, "imageUrl", 2), rN = rD([ed("wcm-wallet-image")], rN);
            ...
            rH([eu()], rZ.prototype, "preload", 2), rZ = rH([ed("wcm-explorer-context")], rZ);
            ...
            let r1 = class extends es {
                ...
                render() {
                    ...
                    return H `<div class="${eg(e)}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${ty(this.walletId)}" imageId="${ty(this.imageId)}"></wcm-wallet-image></div><wcm-text variant="medium-regular" color="${this.isError?"error":"primary"}">${this.isError?"Connection declined":this.label}</wcm-text>`
                }
            };
            r1.styles = [tI.globalCss, rG], r0([ep()], r1.prototype, "walletId", 2), r0([ep()], r1.prototype, "imageId", 2), r0([ep({
                type: Boolean
            })], r1.prototype, "isError", 2), r0([ep({
                type: Boolean
            })], r1.prototype, "isStale", 2), r0([ep()], r1.prototype, "label", 2), r1 = r0([ed("wcm-connector-waiting")], r1);
            let r2 = {
                    manualWallets() {
                        var e, t;
                        let {
                ...
                r5 = {
                    ...
                    manualWalletsTemplate() {
                        return r2.manualWallets().map(e => H `<wcm-wallet-button walletId="${e.id}" name="${e.name}" .onClick="${()=>this.onConnecting(e)}"></wcm-wallet-button>`)
                    },
                    recomendedWalletsTemplate(e = !1) {
                        return r2.recomendedWallets(e).map(e => H `<wcm-wallet-button name="${e.name}" walletId="${e.id}" imageId="${e.image_id}" .onClick="${()=>this.onConnecting(e)}"></wcm-wallet-button>`)
                    },
                    recentWalletTemplate() {
                        let e = r2.recentWallet();
                        if (e) return H `<wcm-wallet-button name="${e.name}" walletId="${e.id}" imageId="${ty(e.image_id)}" .recent="${!0}" .onClick="${()=>this.onConnecting(e)}"></wcm-wallet-button>`
                    }
                },
            ...
            r6.styles = [tI.globalCss, r3], r6 = ((e, t, r, i) => {
            ...
            let il = class extends es {
                ...
                render() {
                    ...
                    return H `<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${tB.QRCODE_ICON}"></wcm-modal-header>${n?H`<wcm-modal-content><div>${a} ${l?H`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>`:null}</div></wcm-modal-content>`:null}`
                }
            };
            ...
            let ih = class extends es {
                ...
                render() {
                    ...
                    return H `<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${eg(e)}" @click="${this.onCloseModal}" role="alertdialog" aria-modal="true"><div class="wcm-container" tabindex="0">${this.open?H`<wcm-modal-backcard></wcm-modal-backcard><div class="wcm-card"><wcm-modal-router></wcm-modal-router><wcm-modal-toast></wcm-modal-toast></div>`:null}</div></div>`
                }
            };
            ih.styles = [tI.globalCss, ia], id([eu()], ih.prototype, "open", 2), id([eu()], ih.prototype, "active", 2), ih = id([ed("wcm-modal")], ih);
            ...
            ig.styles = [tI.globalCss, im], iw([ep({
                type: Boolean
            })], ig.prototype, "isMobile", 2), iw([ep({
                type: Boolean
            })], ig.prototype, "isDesktop", 2), iw([ep({
                type: Boolean
            })], ig.prototype, "isWeb", 2), iw([ep({
                type: Boolean
            })], ig.prototype, "isRetry", 2), ig = iw([ed("wcm-platform-selection")], ig);
            ...
            let ix = class extends es {
                ...
                render() {
                    ...
                    return H `<button @click="${this.onClick}"><div class="wcm-icons">${t.map(e=>{let t=t8.getWalletIcon(e);if(t)return H`<img crossorigin="anonymous" src="${t}">`;let r=t8.getWalletIcon({id:e.id});return r?H` < img crossorigin = "anonymous"
            ...
            let iO = class extends es {
                ...
                render() {
                    return H `<div class="wcm-qr-container">${this.uri?H`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${this.uri}" walletId="${ty(this.walletId)}" imageId="${ty(this.imageId)}"></wcm-qrcode>`:H`<wcm-spinner></wcm-spinner>`}</div>`
                }
            };
            iO.styles = [tI.globalCss, i$], i_([ep()], iO.prototype, "walletId", 2), i_([ep()], iO.prototype, "imageId", 2), i_([eu()], iO.prototype, "uri", 2), iO = i_([ed("wcm-walletconnect-qr")], iO);
            var iE = Object.defineProperty,
                ik = Object.getOwnPropertyDescriptor;
            let iI = class extends es {
                viewTemplate() {
                    return eC.zv.isAndroid() ? H `<wcm-android-wallet-selection></wcm-android-wallet-selection>` : eC.zv.isMobile() ? H `<wcm-mobile-wallet-selection></wcm-mobile-wallet-selection>` : H `<wcm-desktop-wallet-selection></wcm-desktop-wallet-selection>`
                }
                render() {
            ...
            iR.styles = [tI.globalCss, iT], iS([eu()], iR.prototype, "isError", 2), iR = iS([ed("wcm-desktop-connecting-view")], iR);
            ...
            let iD = class extends es {
                ...
                render() {
                    ...
                    return H `<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${ty(r)}" label="Not Detected" .isStale="${!0}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Download ${e} to continue. If multiple browser extensions are installed, disable non ${e} ones and try again`}</wcm-text><wcm-button .onClick="${()=>this.onInstall(i)}" .iconLeft="${tB.ARROW_DOWN_ICON}">Download</wcm-button></wcm-info-footer>`
                }
            };
            ...
            let iZ = class extends es {
                ...
                render() {
                    ...
                    return H `<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${ty(r)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${l}" .isRetry="${!0}"><wcm-button .onClick="${()=>this.openMobileApp(!1)}" .iconRight="${tB.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${n?H`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${()=>this.openMobileApp(!0)}">Try this alternate link</span></wcm-text>`:null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${t}" imageId="${ty(r)}"></wcm-wallet-image><wcm-text>${`Get ${e}`}</wcm-text></div><wcm-button .iconRight="${tB.ARROW_RIGHT_ICON}" .onClick="${()=>this.onGoToAppStore(a)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`
                }
            };
            iZ.styles = [tI.globalCss, iN], iH([eu()], iZ.prototype, "isError", 2), iZ = iH([ed("wcm-mobile-connecting-view")], iZ);
            ...
            let i1 = class extends es {
                ...
                render() {
                    ...
                    return H `<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${eg(s)}"><div class="wcm-grid">${i?null:l} ${i?null:a} ${i?null:r.map(e=>H`${e?H`<wcm-wallet-button imageId="${e.image_id}" name="${e.name}" walletId="${e.id}" .onClick="${()=>this.onConnect(e)}"></wcm-wallet-button>`:null}`)}</div><div class="wcm-placeholder-block">${n?H`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>`:null} ${!n&&this.loading?H`<wcm-spinner></wcm-spinner>`:null}</div></wcm-modal-content>`
                }
            };
            i1.styles = [tI.globalCss, iG], i0([eu()], i1.prototype, "loading", 2), i0([eu()], i1.prototype, "firstFetch", 2), i0([eu()], i1.prototype, "search", 2), i0([eu()], i1.prototype, "endReached", 2), i1 = i0([ed("wcm-wallet-explorer-view")], i1);
            ...
            var i5 = Object.defineProperty,
                ...
                i4 = (e, t, r, i) => {
                    for (var o, l = i > 1 ? void 0 : i ? i3(t, r) : t, a = e.length - 1; a >= 0; a--)(o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
            ...
            i7.styles = [tI.globalCss, i2], i4([eu()], i7.prototype, "isError", 2), i7 = i4([ed("wcm-web-connecting-view")], i7)
        }
    }
]);